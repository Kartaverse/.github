...
Kartaverse is delivered via the web as free LGPL/GPL licensed open-source XR software using the [Reactor package manager](https://www.steakunderwater.com/wesuckless/viewtopic.php?f=32&t=3067) for BMD Resolve/Fusion.
